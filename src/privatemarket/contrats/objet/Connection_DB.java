...
public class Connection_DB {
	...
	public static Titre setTitreEnchere(ResultSet resultSet)
	...
	public static Titre setTitreImmediat(ResultSet resultSet)
			throws NumberFormatException, SQLException {
		Titre titre = new Titre();
		titre.setId(new Integer(resultSet.getString(1)).intValue());
		titre.setPrix(new Double(resultSet.getString(2)));
		titre.setDateCreation(resultSet.getString(3));
		titre.setDateFin(resultSet.getString(4));
		titre.setIdEntreprise(new Integer(resultSet.getString(5)));
		titre.setIdVendeur(new Integer(resultSet.getString(6)));
		titre.setNomEntreprise(Connection_DB.getNomEntreprise(titre
				.getIdEntreprise()));
		titre.setNomVendeur(Connection_DB.getNomVendeur(titre.getIdVendeur()));
		return titre;
	...
	public static Option setOption(ResultSet resultSet)
		...
		option.setPrime(new Double(resultSet.getString(3)));
		option.setStrike(new Double(resultSet.getString(4)));
		option.setDateInitial(resultSet.getString(5));
		option.setDateFinal(resultSet.getString(6));
		option.setBool(new Integer(resultSet.getString(7)));
		option.setStatut(new Integer(resultSet.getString(8)));
		option.setIdEntreprise(new Integer(resultSet.getString(9)));
		option.setIdVendeur(new Integer(resultSet.getString(10)));
		option.setNomEntreprise(getNomEntreprise(option.getIdEntreprise()));
		option.setNomVendeur(getNomVendeur(option.getIdVendeur()));
		return option;
	}

	public static Option setOptionEnchere(ResultSet resultSet)
			throws NumberFormatException, SQLException {
		Option option = new Option();
		option.setIdSOI(new Integer(resultSet.getString(1)).intValue());
		option.setPrixInitial(new Double(resultSet.getString(2)));
		...
		option.setStatut(new Integer(resultSet.getString(8)));
		option.setBool(new Integer(resultSet.getString(9)));
		option.setIdEntreprise(new Integer(resultSet.getString(10)));
		option.setIdVendeur(new Integer(resultSet.getString(12)));
		option.setNomEntreprise(getNomEntreprise(option.getIdEntreprise()));
		option.setNomVendeur(getNomVendeur(option.getIdVendeur()));
		return option;
	}
	...
	public static Titre rechercheTitreUnique(String id, String Requete, int type) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		Titre titre = new Titre();
		...
		try {
			...
			while (resultSet.next()) {
				if (type == 1)
					titre = setTitreEnchere(resultSet);
				else {
					titre = setTitreImmediat(resultSet);
				}
			}
		} catch (Exception e) {
	...
	public static Option rechercheOptionUnique(String id, String Requete,
		...
		try {
			...
			while (resultSet.next()) {
				if (type == 1) {
					option = setOptionEnchere(resultSet);
				} else {
	...
	public static ArrayList<Titre> ListeTitreI(String requete) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		...
		try {
			...
			while (resultSet.next()) {
				...
				resultat.add(Connection_DB.setTitreImmediat(resultSet));
	...
	public static ArrayList<Titre> ListeTitreE(String requete) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		ArrayList<Titre> resultat = null;
		...
		try {
			...
			resultat = new ArrayList<Titre>();
			while (resultSet.next()) {
				resultat.add(Connection_DB.setTitreEnchere(resultSet));
			}
		} catch (Exception e) {
			System.err.println(e.getMessage().toString());
		} finally {
	...
	public static ArrayList<Option> ListeOptionI(String statut, String requete) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
	...
	public static ArrayList<Option> ListeOptionE(String statut, String requete) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		ArrayList<Option> resultat = null;
		...
		try {
			...
			resultat = new ArrayList<Option>();
			while (resultSet.next()) {
				resultat.add(Connection_DB.setOptionEnchere(resultSet));
			}
		} catch (Exception e) {
			System.err.println(e.getMessage().toString());
		} finally {
