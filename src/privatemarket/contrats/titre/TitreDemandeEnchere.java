...
public class TitreDemandeEnchere extends HttpServlet {
	...
	private final static String _SQL_UPDATE_OPERATIONS = "UPDATE privatemarket.titreenchere"
			+ " SET PrixActuel= ?, idAcheteur='5' where idTitre=?";
	private final static String _SQL_SELECT_OPERATIONS = "SELECT PrixActuel from privatemarket.titreenchere where idTitre=?";
	...
	protected void doPost(HttpServletRequest request,
		...
		getServletContext().getRequestDispatcher("/TransactionEnchere.jsp")
