...
<body id="detail">
	<%
		Titre titre = (Titre) session.getAttribute("_LISTE_OPERATIONS_TITRE_ENCHERE");
				...
				<div id="bg_body">
					...
					<form name="form" action="./TitreDemandeEnchere" method="Post">
						<div class="right-achat">
							<div class="box-achat">
								<div class="prix">
									<%=titre.getPrixActuel()%><br /> <span>PRIVATE MARKET
										DONNées en temps réels enchere minimum: <%=titre.getPrixActuel() + 0.01%></span>
								</div>
								<div class="box-input">
