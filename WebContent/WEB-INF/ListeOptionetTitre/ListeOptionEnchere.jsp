...
<title>Liste Option Enchere</title>
</head>
	...
	<div id="content">
		...
		<div id="bg_body_center">
			<div id="bg_body">
				...
				<h2 class="title center">Liste des options en enchère</h2>
				<br /> <br />
				...
				<TABLE id="tab_societes" CELLPADDING=0 CELLSPACING=0>
					...
					<TR class="wl">
						...
						<TD align="center">
							<%
								if (option.getStatut() == 2) {
							%> CALL <%
								}
							%> <%
 	if (option.getStatut() == 3) {
 %> PUT <%
 	}
 %>
						</TD>
						...
						<TD align="center"><form
								action="./OptionEnchere" method="Post">
