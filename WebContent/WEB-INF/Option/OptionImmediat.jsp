	...
	<div id="content">
		...
		<div id="bg_body_center">
			<div id="bg_body">
				...
				%>
				<form name="form" action="./AchatOptionImmediat" method="Post">
					<div class="right-achat">
						<div class="box-achat">
							<div class="prix">
								<%=option.getPrimeInitial()%>
								EUR<br /> <span>PRIVATE MARKET DONNées DIFFéré</span>
							</div>
						...
						<div class="box-achat">
							...
							<div class="right-button">
								<input type="hidden" name="idTitre"
									value="<%=option.getIdSOI()%>"> <input class="send"
									type="submit" /><a onclick="form.submit()"><img
									src="images/icon/vendre.jpg" alt="vendre" /></a>
